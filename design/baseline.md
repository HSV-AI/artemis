...
- Let Artemis schedule a prompt to run once, daily, weekly, or monthly with jobs stored durably in UTC and restricted to the conversation the model is in.
