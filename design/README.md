...
- [Persona auto-selection by author display name](persona-auto-selection.md) — runtime override that applies the `artemis` persona when an incoming author's display name starts with `artemis`.
