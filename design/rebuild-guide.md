...
- Start the scheduler execution engine after Discord reports ready; run due jobs through the full agent in the target conversation's serialized session and post only validated JSON `message` responses.
